<aside class="page-sidebar">
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            ...
            <span class="page-logo-text mr-1">Калькуляторы</span>
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        <div class="nav-filter">
            <div class="position-relative">
                <input type="text" id="nav_filter_input" placeholder="Фильтр меню" class="form-control" tabindex="0">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            <li class="active open">
                <a href="#" title="Application Intel" data-filter-tags="стены">
                    <i class="fal fa-info-circle"></i>
                    <span class="nav-link-text" data-i18n="nav.application_intel">Стены</span>
                </a>
                <ul>
                    <li>
                        <a href="{{route('nagel')}}" title="Стены нагель" data-filter-tags="стены нагель">
                            <span class="nav-link-text" >Нагель</span>
                        </a>
                    </li>
                    <li>
