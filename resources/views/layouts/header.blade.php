    ...
    <div class="ml-auto d-flex">
        ...
        <div>
            <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="/img/demo/avatars/avatar-m.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
            </a>
                ...
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    @auth
                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/img/demo/avatars/avatar-m.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
...
{{--                </a>--}}
                ...
                <a href="#" class="dropdown-item" data-action="app-fullscreen">
                    <span data-i18n="drpdwn.fullscreen">На весь экран</span>
...
{{--                </div>--}}
                ...
                @else
                    <a href="{{ route('login') }}" class="dropdown-item"><span>{{ __('Login') }}</span> </a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="dropdown-item"><span>{{ __('Register') }}</span></a>
                    @endif
                @endif
